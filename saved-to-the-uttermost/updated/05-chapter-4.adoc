== Chapter IVThe Proof of Our Position
...
and does strive with him for a season,
...
For first,
He insinuates that there was a day wherein the inhabitants of
...
So it is after real offers of mercy and salvation are rejected,
...
di' autou (through it) does very well agree with photos (the Light),
...
So that this relative di' autou must necessarily refer to the Light (photos),
...
insisted that this is a measure or endowment insufficient to save the soul.
These argued that there is a common grace (or illumination) by
which all men possess moral discernment between good and evil,
and then a separate and saving grace, which is bestowed upon Christians only.]
Light.
...
the disciples were meant to understand Christ's outward person,
...
footnote:[James 1:21 -- "`ho logos emphutos`"]--which
...
Furthermore, this saving, spiritual Light is the Gospel,
...
and by that they may read and understand the power and Godhead
...
The third proposition which needs to be proved has two parts: First,
...
and the salvation purchased by Him; and second,
...
not be extended to such as are capable of knowing,
...
and know Christ in them, whom James calls "`the Just One +++[+++ton Dikaion],

...
into the prince as being _ultimus hæres,_
...
is not to be sought after: alleging that _res aliter se habet in ecclesia constituenda,
quam in ecclesia constituta,_ that is,

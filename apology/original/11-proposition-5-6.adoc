...
_God,_ out of his infinite love, who delighteth not in the death of a sinner,
...
man needs do nothing but wait for that irresistible juncture,
...
[.syllogism]
* _Arg._ For whomsoever it is lawful to pray, to them salvation is possible:
...
The author __de vocat. Gentium__ (lib. 11. cap. 6):
...
which of its own nature, draws, invites, and inclines to God; and this some
...
and recoils or flees from them, even as the flesh of man flees from that,
...
know and be acquainted with _Christ in_ them, telling them, that Christ is in them.
...
how that divine supernatural Light or Seed is _vehiculum Dei:_
...
that men`'s hearts are hardened,
and not before.
...
and illuminate the inward eyes of all, by a spiritual
splendor:
...
Thirdly, __It is sufficient and saving.__
...
* But such is the _Light_ (1 John 1:7).
* Therefore, etc.
...
4:12-13): "`For the Word of God is quick and powerful,
...
Clement of Alexandria saith _(lib.
2, Stromat.),_ "`The divine Word hath cried, calling all,
...
And _(Paed. lib,+++.+++ 1, cap. 3),_ "`There is,`" saith he,
...
The writer of the [.book-title]#Call of All Nations,# saith _(lib. i, cap. 2),_
...
and legal commands in services and testimonies of the first principles.`" _Cap.
7,_ he saith,
"`That he believes that the help of grace hath been wholly withdrawn from no man.`" _Lib.
2, cap. 1,_ "`Because, albeit salvation is far from sinners,
yet there is nothing void of the presence and virtue of his salvation.`" _Cap.
2,_ "`But seeing none of that people over whom was set both the doctrines,
...
is that supernatural saving grace of God given to _every_ man to save him.
...
[.syllogism]
* _Arg._ To whom the Gospel, the power of God unto salvation, is manifest, they may be saved, whatever outward knowledge they want:
...
[.syllogism]
* _Arg._ If _all_ men have received a loss from Adam, which leads to condemnation; then _all_ men have received a gift from Christ, which leads to justification:
* But the first is true;
* Therefore also the last.
...
[.syllogism]
* _Arg._ In every nation, he that feareth God and worketh righteousness is accepted:
...
For there is no respect of persons with God.`" Where the apostle clearly approves
...
Some called him a Holy Spirit, as Seneca _(Epist.
41),_ who said,
...
cited by Lactantius __(6 Instit.),__^
footnote:[__In Sect. 8.__]
...
and by his working _in_ them were brought from unrighteousness to righteousness,
...
Clement of Alexandria saith _(Apol. ii., Strom. lib. i.),_
...
"`Nor do I think,`" saith Augustine, in his book of the [.book-title]#City of God,# _lib. 18, cap. 47,_
...
Augustine also testifies in his [.book-title]#Confessions# _(lib.
7, cap. 9),_ that "`he had read in the writings of the Platonists,
...
Of this Light therefore Augustine speaks in his [.book-title]#Confessions# _(lib.
11, cap. 9):_ "`In this beginning, O God! thou madest the heavens and the earth, in thy Word,
...
which had again covered me, after I was departed from that darkness and heap
of my punishments.`" And again he saith _(lib.
x., cap.
27),_ "`It is too late that I have loved thee, O thou beautifulness, so ancient,

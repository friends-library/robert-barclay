...
is ignorant that it is incongruous to say _"`vos amas,`"_ _"`vos legis,`"_ that is,
...
Plato also stood against oaths in his judgments ([.book-title]#De Leg.#
...
as appears from Justin Martyr in_ Dialog. cum Tryph. ejusdemque Apolog. 2. Item, ad Zenam._
...
footnote:[Matt. 26:52.]
Concerning which Tertullian speaks well [.book-title]#(lib.
...
he disarmed every soldier in disarming of Peter.`" [.book-title]#Idem+++.+++, de Coron.
...
as Sylvius [.book-title]#Disc. de Rev. Belg.#
...
Viv. writes well [.book-title]#(lib. de con. vit. Christ. sub. Turc.),#
by relation of Fredericus Sylvius, [.book-title]#Disc.
de Revol. Belg+++.+++,# p. 85:

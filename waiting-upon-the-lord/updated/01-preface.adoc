...
proposition of Robert Barclay's Apology for the True Christian Divinity.^
footnote:[Robert Barclay's Apology for the True
Christian Divinity is made available online for free,
and hardcover copies can be purchased through Quaker Heritage Press.
www.qhpress.org]
The entire volume of Barclay's Apology (consisting of fifteen
...
from the Works of Isaac Penington on the same subject.
